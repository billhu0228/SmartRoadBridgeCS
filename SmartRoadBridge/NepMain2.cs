...
{
    public struct CBDeterminID
    {
        public double SlopValue;
        public double H;
        public int A;
        public int B;
    }
    ...
    public struct PlinthStruc
    {
        public double Hineed;
        public Point2D Loc;
        public Point2D PinLoc;
        public bool BackSide;
        public string Name;
    }
    public class NepMain2
    {
        static Align M1K, L1K, R1K, M2K, M3K;
        static Align SBE, EBA;
        static Align JKA, MLA,SGRA;
        ...
        /// 数据初始化
        /// </summary>
        public NepMain2(string server, string port, string user, string pw, string db)
        {
            MainDatabaseName = db;
            ...
            AlignDict = new Dictionary<string, Align>()
            {
                ...
                {"MUA",MUA},{"MUB",MUB},{"MUC",MUC},{"WLR",WLR},{ "A8L2",A8L2},{"SGRA",SGRA}
            };
            ...
            BridgeCSVDict = new Dictionary<string, string>()
            {
                ...
                {"SEC208","SEC208.csv"},{"SEC209","SEC209.csv"},{"SEC210","SEC210.csv"},{"A8L01","A8L01.csv"},{"SGR01","SGR01.csv"},
            };
            ...
            {
                {"A8L01","SEC1(L2K0+323.670 - L2K0+353.670) ROAD RECONSTRUCTION A8L2 - A8L01"},
                {"CCI01","SEC2(AK0+107.542 - AK0+227.500) CAPITAL CENTER INTERCHANGE - CCI01"},
                {"CCI02","SEC2(BK0+360.350 - BK0+538.075) CAPITAL CENTER INTERCHANGE - CCI02"},
                {"CCI03","SEC2(CK0+392.000 - CK0+592.351) CAPITAL CENTER INTERCHANGE - CCI03"},
                {"CCI04","SEC2(DK0+126.428 - DK0+276.429) CAPITAL CENTER INTERCHANGE - CCI04"},
                {"EBI01","SEC1(AK0+280.300 - AK0+742.300) EASTERN BYPASS INTERCHANGE - EBI01"},
                ...
                {"JKI01","SEC1(AK0+494.420 - AK0+554.420) JKIA INTERCHANGE - JKI01"},
                {"MHI01","SEC2(AK0+116.613 - AK0+267.300) MUSEUM HILL INTERCHANGE - MHI01"},
                {"MHI02","SEC2(BK0+278.523 - BK0+458.721) MUSEUM HILL INTERCHANGE - MHI02"},
                {"MHI03","SEC2(CK0+248.463 - CK0+398.463) MUSEUM HILL INTERCHANGE - MHI03"},
                {"MLI01","SEC1(AK0+020.000 - AK0+082.000) MLOLONGO INTERCHANGE - MLI01"},
                {"SGR01","SEC1(AK0+024.370 - AK0+086.370) SGR INTERCHANGE - SGR01"},
                {"SBI05","SEC1(EK0+302.850 - EK0+858.850) SOUTHERN BYPASS INTERCHANGE - SBI05"},
                {"SEC101","SEC1(M1K6+802 - M1K6+892) MAINLINE BRIDGE - ML01"},
                {"SEC102","SEC1(M1K7+537 - M1K7+657) MAINLINE BRIDGE - ML02"},
                {"SEC103","SEC1(M1K11+658 - M1K11+688) MAINLINE BRIDGE - ML03"},
                {"SEC104","SEC1(M1K12+145 - M1K12+235) MAINLINE BRIDGE - ML04"},
                {"SEC201","SEC2(M1K15+710 - M1K16+160) MAINLINE BRIDGE - ML01"},
                {"SEC202","SEC2(M1K16+160 - M1K17+490) MAINLINE BRIDGE - ML02"},
                {"SEC203","SEC2(M1K17+490 - M1K18+635) MAINLINE BRIDGE - ML03"},
                {"SEC204L","SEC2(M1K18+635 - M2K20+071) MAINLINE BRIDGE - ML04L"},
                {"SEC204R","SEC2(M1K18+635 - M2K20+071) MAINLINE BRIDGE - ML04R"},
                {"SEC205","SEC2(M2K20+071 - M2K21+056) MAINLINE BRIDGE - ML05"},
                {"SEC206","SEC2(M2K21+056 - M2K22+657) MAINLINE BRIDGE - ML06"},
                {"SEC207","SEC2(M2K22+657 - M2K22+957) MAINLINE BRIDGE - ML07"},
                {"SEC208","SEC2(M2K22+957 - M2K23+287) MAINLINE BRIDGE - ML08"},
                {"SEC209","SEC2(M2K23+287 - M2K24+337) MAINLINE BRIDGE - ML09"},
                {"SEC210","SEC2(M3K26+635 - M3K26+755) MAINLINE BRIDGE - ML10"},
                {"WLI01","SEC2(AK0+279.000 - AK0+369.049) WESTLANDS INTERCHANGE - WLI01"},
            };
